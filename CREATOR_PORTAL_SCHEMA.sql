-- ============================================================================
-- CREATOR PORTAL DATABASE SCHEMA
-- ============================================================================
-- Complete database schema for Creator Portal including courses, lessons,
-- sections, enrollments, progress tracking, reviews, and analytics
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS course_enrollments (
  ...
  -- Access Control
  access_until TIMESTAMPTZ, -- For time-limited courses
...
CREATE TABLE IF NOT EXISTS course_messages (
  ...
  -- Metadata
  lesson_id UUID REFERENCES lessons(id) ON DELETE SET NULL, -- Optional: message about specific lesson
...
CREATE TABLE IF NOT EXISTS notifications (
  ...
  type TEXT NOT NULL, -- 'enrollment', 'message', 'review', 'completion', 'payment'
  title TEXT NOT NULL,
  message TEXT NOT NULL,
...
-- Function: Update course stats when enrollment is created
...
-- Function: Update course rating when review is created/updated
...
COMMENT ON TABLE lesson_progress IS 'Student progress tracking for each lesson';
COMMENT ON TABLE course_reviews IS 'Student reviews and ratings for courses';
COMMENT ON TABLE course_messages IS 'Messages between students and creators';
