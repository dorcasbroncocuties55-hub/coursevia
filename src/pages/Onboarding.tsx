  ...
  const finishOnboarding = async () => {
    ...
    try {
      ...
      const rpcPayload = {
        ...
        p_services_offered:        servicesOffered.trim() || null,
        p_works_with:              worksWith.trim() || null,
        p_expertise_areas:         expertiseAreas.trim() || null,
        p_service_areas:           serviceAreas.trim() || null,
        p_service_delivery_mode:   serviceDeliveryMode || null,
        ...
        p_learner_interests:       learnerInterests.trim() || null,
