...
const Signup = () => {
  ...
  const typingTexts = [
    ...
    "Become a creator and share your knowledge",
  ...
  const displayedText = useTypingEffect(typingTexts, 80, 40, 2000);
  ...
  return (
    <div className="min-h-screen bg-white flex">
      ...
      <div className="w-full lg:w-1/2 flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center px-4 py-12">
          <div className="w-full max-w-[420px]">
            <div className="mb-8">
              <h1 className="text-[28px] font-bold text-gray-900 mb-1">Create your account</h1>
            ...
            <form onSubmit={handleSignup} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full rounded-xl bg-primary px-4 py-3.5 text-sm font-semibold text-white hover:opacity-90 transition disabled:opacity-60 flex items-center justify-center gap-2 shadow-sm"
              >
      ...
      {/* Right Side - Inspiring Content with Typing Animation */}
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary via-emerald-600 to-teal-700 items-center justify-center p-12 relative overflow-hidden">
        {/* Animated background elements */}
        <div className="absolute inset-0 opacity-20">
          <div className="absolute top-1/4 right-1/4 w-72 h-72 bg-white rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute bottom-1/3 left-1/3 w-96 h-96 bg-emerald-300 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1.5s' }}></div>
        </div>
        ...
        <div className="relative z-10 max-w-lg text-white">
          ...
          <div className="mb-10">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-sm font-semibold text-white/80 uppercase tracking-wider">Your Journey Starts Here</span>
            </div>
            <h2 className="text-4xl font-bold mb-4 min-h-[96px]">
              {displayedText}
          ...
          <div className="space-y-5">
            <div className="flex items-start gap-4 text-white/95">
              <div className="flex-shrink-0 w-10 h-10 rounded-full bg-white/20 flex items-center justify-center">
                <span className="text-lg font-bold">1</span>
              </div>
              <div>
                <h3 className="font-semibold mb-1">Learn from Experts</h3>
                <p className="text-sm text-white/80">Access courses from industry professionals worldwide</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 text-white/95">
              ...
              <div>
                <h3 className="font-semibold mb-1">Grow Your Skills</h3>
                <p className="text-sm text-white/80">Practice with real-world projects and get certified</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 text-white/95">
              ...
              <div>
                <h3 className="font-semibold mb-1">Build Your Business</h3>
                <p className="text-sm text-white/80">Create and sell your own courses or services</p>
              </div>
            </div>
          </div>
