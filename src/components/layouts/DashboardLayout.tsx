...
const coachNav: NavItem[] = [
  ...
  { label: "Transfers", href: "/coach/withdrawals", icon: Send },
...
const therapistNav: NavItem[] = [
  ...
  { label: "Transfers", href: "/therapist/withdrawals", icon: Send },
...
const creatorNav: NavItem[] = [
  ...
  { label: "Transfers", href: "/creator/withdrawals", icon: Send },
