...
// Figma nav: Dashboard, Clients, Services, Books, Session Notes, Messages, Wallet, Payouts, Settings
const NAV = [
  { href: "/coach/dashboard", label: "Dashboard", icon: LayoutDashboard },
  { href: "/coach/clients", label: "Clients", icon: Users },
  { href: "/coach/services", label: "Services", icon: ClipboardList },
  { href: "/coach/bookings", label: "Books", icon: CalendarCheck },
  { href: "/coach/sessions", label: "Session Notes", icon: ClipboardList },
  { href: "/coach/messages", label: "Messages", icon: MessageSquare },
  { href: "/coach/wallet", label: "Wallet", icon: Wallet },
  { href: "/coach/withdrawals", label: "Payouts", icon: CreditCard },
